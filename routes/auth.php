...
Route::group(['middleware' => ['auth', 'throttle:api']], function () {
    ...
    // Open Shop
    Route::group(['middleware' => ['check_role:user', 'check_status', 'check_banned']], function() {
    ...
    Route::group(['middleware' => ['check_role:seller', 'check_status', 'check_banned']], function() {
...
Route::group(['middleware' => ['auth', 'check_role:user,seller,admin', 'check_status', 'check_banned', 'throttle:api']], function() {
...
// Ganti Password
Route::group(['middleware' => ['auth', 'check_role:user,seller', 'check_status', 'check_change_pwd_status', 'check_banned', 'throttle:api']], function() {
...
Route::group(['middleware' => ['auth', 'check_role:user,seller', 'check_status', 'check_banned', 'throttle:api']], function() {
...
Route::group(['middleware' => ['auth', 'check_role:user,seller', 'check_status', 'check_banned']], function() {
