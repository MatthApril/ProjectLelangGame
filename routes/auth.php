...
Route::group(['middleware' => ['auth', 'check_role:user,seller,admin', 'check_status', 'check_banned']], function() {
...
// Ganti Password
Route::group(['middleware' => ['auth', 'check_role:user,seller', 'check_status', 'check_change_pwd_status', 'check_banned']], function() {
