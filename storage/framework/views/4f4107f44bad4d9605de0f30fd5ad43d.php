                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="d-flex justify-content-center align-items-center">
                            <img src="<?php echo e(asset('images/Logo/LogoWarna-RemoveBg.png')); ?>" alt="LelangGame Logo" width="100">
                        ...
                        <form action="<?php echo e(route('doRegister')); ?>" method="post">
                            ...
                            <div class="input-group flex-nowrap mb-3">
                                <span class="input-group-text" id="addon-wrapping"><i class="bi bi-key-fill"></i></span>
                                <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" placeholder="Konfirmasi Password" autocomplete="off" required>
                            </div>
                            <div class="d-grid">
                                <button type="submit" class="btn btn-primary rounded-5 my-3">Daftar</button>
                            </div>
                            <hr>
                            <div class="text-center my-3">Sudah Punya Akun? <a href="<?php echo e(route('login')); ?>">Masuk Sekarang</a></div>
                        </form>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH D:\xampp\htdocs\ProjectLelangGame\resources\views/pages/auth/register.blade.php ENDPATH**/ ?>