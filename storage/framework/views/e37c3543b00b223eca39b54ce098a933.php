    ...
    <div class="container-fluid">
        ...
        <div class="row px-5">
            <div class="col-md-3 my-3">
                ...
                <h6 class="mt-5 fw-bold ">LelangGame</h6>
                <a href="#" class="text-decoration-none text-secondary link-footer">Tentang LelangGame</a><br>
                <a href="#" class="text-decoration-none text-secondary link-footer">LelangGame Blog</a><br>
                <a href="#" class="text-decoration-none text-secondary link-footer">Hubungi Kami</a><br>
                <a href="#" class="text-decoration-none text-secondary link-footer">Aturan Penggunaan</a><br>
                <a href="#" class="text-decoration-none text-secondary link-footer">Kebijakan Privasi</a><br>
            </div>
            <div class="col-md-3 my-3">
                <h6 class="fw-bold">Pembeli</h6>
                <a href="#" class="text-decoration-none text-secondary link-footer">Cara Belanja</a><br>
                <a href="#" class="text-decoration-none text-secondary link-footer">Cara Pembayaran</a><br>

                <h6 class="mt-5 fw-bold">Penjual</h6>
                <a href="#" class="text-decoration-none text-secondary link-footer">Cara Menjadi Penjual</a><br>
                <a href="#" class="text-decoration-none text-secondary link-footer">Biaya Berjualan</a><br>
                <a href="#" class="text-decoration-none text-secondary link-footer">Metode Pencairan Saldo</a><br>
                <a href="#" class="text-decoration-none text-secondary link-footer">Testimoni Penjual</a><br>
            </div>
            <div class="col-md-3 my-3">
...
</footer><?php /**PATH D:\xampp\htdocs\ProjectLelangGame\resources\views/partials/footer.blade.php ENDPATH**/ ?>