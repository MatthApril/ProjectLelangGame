                ...
                <div class="card shadow">
                    <div class="card-body">
                        <div class="d-flex justify-content-center align-items-center">
                            <img src="{{ asset('images/Logo/LogoWarna-RemoveBg.png') }}" alt="LelangGame Logo" width="100">
                        ...
                        <form action="{{ route('doRegister') }}" method="post">
                            ...
                            <hr>
                            <div class="text-center my-3">Sudah Punya Akun? <a href="{{ route('login') }}">Masuk Sekarang</a></div>
                        </form>
                    </div>
                </div>
            </div>
