                ...
                <form action="{{ route('seller.withdraws.request') }}" method="POST" class="mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('amount') is-invalid @enderror" id="amount"
                            name="amount" value="{{ old('amount') }}" min="10000" placeholder="Min : IDR 10000" required>
                            @error('amount')
                    ...
                    <button type="submit" class="btn btn-success float-end">Ajukan Penarikan <i class="bi bi-caret-right-fill"></i></button>
                </form>
            </div>
        </div>
