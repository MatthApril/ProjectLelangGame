...
@section('content')
    <div class="container mt-3">
        ...
        @enderror
        <form
            action="{{ $product ? route('seller.products.update', $product->product_id) : route('seller.products.store') }}"
            ...
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    @endif
                    <label>Gambar Produk {{ $product ? '' : '*' }} <span class="text-secondary">(Disarankan Ukuran Gambar
                            16 : 9)</span></label>
                    <input type="file" id="product_img" name="product_img" accept="image/*"
                        {{ $product ? '' : 'required' }} class="form-control">
            ...
            <div class="text-end mt-2">
                <a href="{{ route('seller.products.index') }}" class="btn btn-danger"><i class="bi bi-x-lg"></i>
                    Batal</a>
