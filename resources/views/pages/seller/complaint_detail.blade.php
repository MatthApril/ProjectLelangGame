                    ...
                    <form action="{{ route('seller.complaints.respond', $complaint->complaint_id) }}" method="POST"
                        ...
                        <div>
                            ...
                            <textarea name="message" rows="5" required maxlength="1000"
                                placeholder="Jelaskan Pembelaan Anda Dengan Detail (Minimal 20 Karakter)" class="form-control">{{ old('message') }}</textarea>
                        ...
                        <button type="submit"
                            onclick="return confirm('Pastikan tanggapan Anda sudah benar. Kirim tanggapan?')"
