            ...
            <div class="card-body p-0">
                            ...
                            <tbody>
                                @foreach ($topBids as $index => $bid)
                                    <tr class="{{ $index == 0 ? 'table-warning' : '' }}">
                                        ...
                                        <td class="text-end">
                                            <span
                                                class="fw-bold {{ $index == 0 ? 'text-success fs-5' : 'text-primary' }}">
                ...
                @else
                    <div class="text-center py-5">
                        <img src="{{ asset('images/empty-bid.png') }}" alt="No Bids"
                            style="max-width: 150px; opacity: 0.5;" onerror="this.style.display='none'">
