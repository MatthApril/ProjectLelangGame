                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if ($complaint->decision === 'refund')
                                <p>Keputusan : <span class="text-success fw-semibold"><i class="bi bi-check-lg"></i> Uang
                                        Dikembalikan</span></p>
                            @elseif($complaint->decision === 'reject')
                                <p>Keputusan : <span class="text-danger fw-semibold"><i class="bi bi-x-lg"></i> Komplain
                                        Ditolak</span></p>
                            @else
        ...
        @else
            <div class="text-center mt-5">
                ...
                <div>
                    ...
                    <a href="{{ route('user.orders') }}" class="btn btn-outline-primary rounded rounded-5"><i
                            class="bi bi-cash-coin"></i> Lihat Transaksi</a>
                </div>
            </div>
        @endif
    </div>
