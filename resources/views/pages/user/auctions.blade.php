...
@section('content')
    ...
    <div class="container my-4">
        ...
        <form method="GET" action="{{ route('auctions.index') }}">
            <input type="search" name="search" placeholder="Cari Lelang" value="{{ request('search') }}"
            ...
            <div class="row">
                <div class="col-md-3 mt-3">
                    <div class="d-grid">
                        <button type="reset" class="btn btn-outline-secondary rounded-5"><i
        ...
        <div class="d-flex justify-content-between align-items-center mt-3">
            <p class="text-muted">
                @if ($auctions->total() > 0)
                    Menampilkan {{ $auctions->firstItem() ?? 0 }} - {{ $auctions->lastItem() ?? 0 }} dari
                    {{ $auctions->total() }} lelang
                @endif
            </p>
            <div>
