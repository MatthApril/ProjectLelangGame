...
@section('content')
    ...
    <div class="container my-4">
        ...
        <hr>
        <input type="search" name="search" placeholder="Cari Lelang" value="{{ request('search') }}" class="form-control"
            autocomplete="off">
        <form method="GET" action="{{ route('auctions.index') }}">
            ...
            <div class="row">
                <div class="col-md-3 mt-3">
                    <div class="d-grid">
                        <a href="{{ route('auctions.index') }}" class="btn btn-outline-secondary rounded-5"><i
