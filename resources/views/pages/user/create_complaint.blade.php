...
<div class="container">
        <nav nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb mt-3">
                ...
                <li class="breadcrumb-item"><a href="{{ route('user.orders.detail', $orderItem->order_id) }}">Detail Transaksi</a></li>
        ...
        <div class="card-body">
            <form action="{{ route('user.complaints.store', $orderItem->order_item_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>Harap sertakan <strong>deskripsi masalah</strong> dan <strong>bukti pendukung</strong> yang jelas serta valid.</li>
                        <li>Seller wajib memberikan respons maksimal dalam waktu <strong>24 jam</strong> setelah komplain diajukan.</li>
                        <li>Admin akan melakukan peninjauan terhadap bukti dari kedua belah pihak dan <strong>keputusan admin bersifat final</strong>.</li>
                    </ul>
                </div>
            </div>
            <div class="card-footer">
                <div class="text-end">
                    ...
                    <button type="submit" onclick="return confirm('Pastikan data yang Anda masukkan sudah benar. Ajukan komplain?')" class="btn btn-success">
