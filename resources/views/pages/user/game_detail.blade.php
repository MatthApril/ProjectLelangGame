...
@section('content')
    ...
    <div class="container">
            ...
            <div class="card-body">
                <div class="row d-flex align-items-center">
                    <div class="col-md-4 text-center">
                        @if ($game->game_img)
                            <img src="{{ asset('storage/' . $game->game_img) }}" alt="" width="300"
                                class="img-fluid">
                        @endif
                    </div>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                @foreach ($categories as $category)
                                    <button class="btn btn-outline-primary btn-sm"
                                        disabled>{{ $category->category_name }}</button>
                                @endforeach
                            </div>
                        @endif
                    </div>
        ...
        <hr>
        <input type="search" name="search" placeholder="Cari Produk {{ $game->game_name }}"
                    ...
                    <div class="col-md-3 mt-2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="text-primary fw-semibold">Rp{{ number_format($product->price, 0, ',', '.') }}
                                </h5>
